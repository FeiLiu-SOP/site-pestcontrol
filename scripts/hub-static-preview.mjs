/**
 * Local preview for Cloudflare Hub layout: all HTML lives under dist/<segment>/.
 * Astro `preview` + base + nest can 404 on `/pestcontrol/`; this serves `dist/` verbatim.
 *
...
const server = http.createServer((req, res) => {
  ...
  if (!filePath || !filePath.startsWith(path.resolve(root))) {
    ...
    res.end(`404 Not Found\nPath: ${pathname}\nHint: open http://localhost:${port}${hubPrefix}/`);
    return;
  }
